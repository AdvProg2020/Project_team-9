...
//            writer.close();
            ...
            String shareBody = currentProduct.getFileContents();
            /*The type of the content is text, obviously.*/
            intent.setType("text/plain");
            /*Applying information Subject and Body.*/
            intent.putExtra(android.content.Intent.EXTRA_SUBJECT, "فایل دانلود شده");
            intent.putExtra(android.content.Intent.EXTRA_TEXT, shareBody);
            /*Fire!*/
            startActivity(Intent.createChooser(intent, "فایل شما آماده است"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
