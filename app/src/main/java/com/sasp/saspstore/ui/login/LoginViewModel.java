...
import com.sasp.saspstore.data.LoginRepository;
import com.sasp.saspstore.data.Result;
import com.sasp.saspstore.data.model.LoggedInUser;
...
public class LoginViewModel extends ViewModel {
    ...
    public void loginDataChanged(String username, String password) {
        if (!isUserNameValid(username)) {
            ...
            loginFormState.setValue(
                    new LoginFormState(null, R.string.invalid_password));
        } else {
